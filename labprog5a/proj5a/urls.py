"""
URL configuration for proj4b project.
...
from app5a.views import home, studentlist, courselist, enrolledStudents, add_project, StudentListView, StudentDetailView, generateCSV, generatePDF, registerajax
